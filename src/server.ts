...
import { orderCreate, orderCancel, orderConfirm, orderUserSales, 
...
// Route that returns user order history
app.get("/v1/:userId/order/history", async (req: Request, res: Response) => {
  const userId = parseInt(req.params.userId);
