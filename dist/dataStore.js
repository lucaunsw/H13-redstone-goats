    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const billingRes = yield client.query(`INSERT INTO BillingDetails (credit_card_no, cvv, expiry_date)
             VALUES ($1::BIGINT, $2::INTEGER, $3::TEXT) RETURNING id`, [billingDetails.creditCardNumber, billingDetails.CVV, billingDetails.expiryDate]);
...
function clearUsers() {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield db_1.default.query("DELETE FROM Users RETURNING *");
        return (res.rows.length > 0);
    });
}
...
function clearTokens() {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield db_1.default.query("DELETE FROM Tokens RETURNING *");
        return (res.rows.length > 0);
    });
}
...
function clearItems() {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield db_1.default.query("DELETE FROM Items RETURNING *");
        return (res.rows.length > 0);
    });
}
