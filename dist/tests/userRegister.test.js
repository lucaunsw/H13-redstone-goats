...
describe('userRegister', () => {
    ...
    test('A user successfully registers', () => __awaiter(void 0, void 0, void 0, function* () {
        const resp = yield (0, testHelper_1.userRegister)(`testemail@email.com`, `example123`, `firstName`, `lastName`);
    ...
    test('User enters invalid character in first name', () => __awaiter(void 0, void 0, void 0, function* () {
        const resp = yield (0, testHelper_1.userRegister)('testemail@email.com', 'ExamplePassword1', 'John@doe', 'lastname');
        expect(resp.statusCode).toBe(400);
        expect(resp.body).toStrictEqual({ error: expect.any(String) });
    }));
    test('User enters invalid last name', () => __awaiter(void 0, void 0, void 0, function* () {
        const resp = yield (0, testHelper_1.userRegister)('testemail@email.com', 'ExamplePassword2', 'firstname', 'last@name');
        expect(resp.statusCode).toBe(400);
        expect(resp.body).toStrictEqual({ error: expect.any(String) });
    }));
    ...
    test('Password does not contain a number', () => __awaiter(void 0, void 0, void 0, function* () {
        const resp = yield (0, testHelper_1.userRegister)('testemail@email.com', 'examplepassword', 'firstname', 'lastname');
        expect(resp.statusCode).toBe(400);
        expect(resp.body).toStrictEqual({ error: expect.any(String) });
    }));
    test('Password does not contain a letter', () => __awaiter(void 0, void 0, void 0, function* () {
        const resp = yield (0, testHelper_1.userRegister)('testemail@email.com', '12345678', 'firstname', 'lastname');
        expect(resp.statusCode).toBe(400);
        expect(resp.body).toStrictEqual({ error: expect.any(String) });
    }));
