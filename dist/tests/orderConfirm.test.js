...
describe("Tests for orderConfirm", () => {
    test("Should confirm an order successfully", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockOrder = {
            id: testBuyer.id,
            items: [testItem],
            quantities: [2],
        ...
        dataStore_1.getOrderXML.mockResolvedValue('Example XML');
        const result = yield (0, app_1.orderConfirm)(userId, Number(orderId));
        expect(result).toStrictEqual({ UBL: expect.any(String) });
        expect(dataStore_1.getOrder).toHaveBeenCalledWith(orderId);
    }));
    test("Should return 401 for invalid orderId", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockOrder = {
            id: testBuyer.id,
            items: [testItem],
            quantities: [2],
        ...
        let result;
        try {
            result = yield (0, app_1.orderConfirm)(userId, orderId);
        }
        catch (error) {
    ...
    test("Should return 401 for invalid userId", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockOrder = {
            id: testBuyer.id,
            items: [testItem],
            quantities: [2],
        ...
        let result;
        try {
            result = yield (0, app_1.orderConfirm)(userId + 1000, orderId);
        }
        catch (error) {
            if (error instanceof Error) {
                result = { error: error.message };
        ...
        expect(result).toStrictEqual({ error: expect.any(String) });
        expect(dataStore_1.getOrder).not.toHaveBeenCalledWith(orderId);
    }));
    test("Should return 400 since order is cancelled", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockOrder = {
            id: testBuyer.id,
            items: [testItem],
            quantities: [2],
